...
describe('Hooks operations.', function () {
    test('useGetCookies should return all cookies.', function () {
        var result = (0, react_1.renderHook)(function () { return (0, index_1.useGetCookies)(); }).result;
    ...
    test('useSetCookie should set a cookie', function () {
        var result = (0, react_1.renderHook)(function () { return (0, index_1.useSetCookie)(); }).result;
    ...
    test('useDeleteCookie should remove a cookie', function () {
        var result = (0, react_1.renderHook)(function () { return (0, index_1.useDeleteCookie)(); }).result;
    ...
    test('useHasCookie should return true for existing cookie', function () {
        var result = (0, react_1.renderHook)(function () { return (0, index_1.useHasCookie)(); }).result;
    ...
    test('useGetCookie should return undefined for non-existing cookie', function () {
        var result = (0, react_1.renderHook)(function () { return (0, index_1.useGetCookie)(); }).result;
